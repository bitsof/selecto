...
POSTGRESQL_DB_NAME = env_config.data.get('POSTGRESQL_DB_NAME', "EMPTY")
POSTGRESQL_USER = env_config.data.get('POSTGRESQL_USER', "EMPTY")
POSTGRESQL_PW = env_config.data.get('POSTGRESQL_PW', 'EMPTY')
POSTGRESQL_HOST = env_config.data.get('POSTGRESQL_HOST', "EMPTY")
POSTGRESQL_PORT = env_config.data.get('POSTGRESQL_PORT', 'EMPTY')
print("done config")
